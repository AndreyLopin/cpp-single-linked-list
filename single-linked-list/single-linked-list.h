...
public:
    ...
    void InitListFromIterators(Iterator begin, Iterator end) {
        Node * tmp = &head_;
    ...
    SingleLinkedList(std::initializer_list<Type> values) : 
        head_(Node()),
        size_(0) {
        InitListFromIterators(values.begin(), values.end());
    }

    SingleLinkedList(const SingleLinkedList& other) : 
        head_(Node()),
        size_(0) {
        InitListFromIterators(other.begin(), other.end());
    }
    ...
    [[nodiscard]] Iterator begin() noexcept {
        return static_cast<Iterator>(head_.next_node);
    }
    ...
    [[nodiscard]] Iterator before_begin() noexcept {
        return static_cast<Iterator>(head_ptr_);
    }
...
template <typename Type>
bool operator<(const SingleLinkedList<Type>& lhs, const SingleLinkedList<Type>& rhs) {
    size_t size = lhs.GetSize() > rhs.GetSize() ? rhs.GetSize() : lhs.GetSize();
